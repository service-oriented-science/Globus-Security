...
public class AuthorizationEngine {
	...
	private AuthorizationEngineSpi delegate;

	public AuthorizationEngine(AuthorizationEngineSpi delegate) {
		this.delegate = delegate;
	}

	public void close() throws CloseException {
		this.delegate.engineClose();
	}

	public Decision authorize(RequestEntities reqAttribute, EntityAttributes resourceOwner) throws AuthorizationException {
		return this.delegate.engineAuthorize(reqAttribute, resourceOwner);
	}
}
