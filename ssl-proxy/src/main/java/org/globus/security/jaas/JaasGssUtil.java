 ...
 */
public final class JaasGssUtil {
     ...
     * a <code>org.globus.security.jaas.GlobusPrincipal</code>
     ...
     * <code>org.globus.security.jaas.GlobusPrincipal</code>
     * is added to the principals set of the Subject object.
    ...
    public static GSSCredential getCredential(Subject subject) {
        ...
        return gssCreds.isEmpty() ? null : gssCreds.iterator().next();
    }
