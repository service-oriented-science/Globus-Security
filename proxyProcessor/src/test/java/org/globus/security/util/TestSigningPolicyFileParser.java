...
public class TestSigningPolicyFileParser {
    ...
    public void testFileSuccess() throws Exception {
        ...
        Map<X500Principal, SigningPolicy> map =
                parser.parse(this.successFile.getTempFilename());
        ...
        Vector allowedDN = policy.getAllowedDNs();
        ...
        map.clear();
        map = parser.parse(this.singleAllowedDn.getTempFilename());
    ...
    public void testFilesWithTab() throws Exception {
        ...
        Map<X500Principal, SigningPolicy> map =
                parser.parse(this.tabTestFiles[0].getTempFilename());
        ...
        map = parser.parse(this.tabTestFiles[1].getTempFilename());
        ...
        map = parser.parse(this.tabTestFiles[2].getTempFilename());
