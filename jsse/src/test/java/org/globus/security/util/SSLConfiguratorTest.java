...
import org.globus.crux.jsse.GlobusSSLConfigurationException;
...
public class SSLConfiguratorTest {
	...
	public void testConfig() throws Exception {
		...
		config
				.setCredentialStoreLocation("classpath:/configuratorTest/mykeystore.properties");
		config.setCredentialStorePassword("password");
		config.setCredentialStoreType(GlobusProvider.KEYSTORE_TYPE);

		config
				.setTrustAnchorStoreLocation("classpath:/configuratorTest/mytruststore.properties");
