...
import org.globus.security.authorization.cxf.GlobusSecurityFeature;
...
public class ServiceNamespaceHandler extends NamespaceHandlerSupport {
    public void init() {
        super.registerBeanDefinitionParser("secureService", new SimpleBeanDefinitionParser(GlobusSecurityFeature.class));
    }
}
